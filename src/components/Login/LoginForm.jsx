          ...
          <div className="wrap-login100">
            ...
            >
              ...
              <div className="wrap-input100 validate-input">
                <input
                  className={
                    inputEmailHasValue ? "input100 has-val" : "input100"
                  }
                  type="text"
                  name="email"
                  onChange={(e) => {
                    ...
                    inputEmail.length > 0
                      ? setInputEmailHasValue(true)
                      : setInputEmailHasValue(false);
                  }}
                />
                <span
              ...
              <div className="wrap-input100 validate-input">
                <input
                  className={
                    inputPasswordHasValue ? "input100 has-val" : "input100"
                  }
                  ...
                  onChange={(e) => {
                    ...
                    inputPassword.length > 0
                      ? setInputPasswordHasValue(true)
                      : setInputPasswordHasValue(false);
                  }}
                />
                <span
                  className="focus-input100"
